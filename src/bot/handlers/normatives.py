...
from utils.database import get_standard_by_id
...
async def normative(call: CallbackQuery):
    ...
    if not standards:
        ...
        - Стойка на руках: {standards['handstand'] or 'н/ф'}
        ...
        - Удержание акселя: {standards['axel_hold'] or 'н/ф'}
